...
const Footer = ({
  ...
  return (
    <View style={[styles.container, { borderTopColor: theme.primary }]}>
      {/* Main footer content */}
      <ScrollView
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.primary }]}>À Propos</Text>
          <TouchableOpacity
            style={styles.link}
            onPress={onAbout}
            activeOpacity={0.7}
        ...
        {/* Section 3 - Légal */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.primary }]}>Légal</Text>
          <TouchableOpacity
            style={styles.link}
            onPress={onTerms}
            activeOpacity={0.7}
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.primary }]}>Nous suivre</Text>
