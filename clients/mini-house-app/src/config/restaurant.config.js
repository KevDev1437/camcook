 ...
 * Cette app est configurée pour: Mini house
 * 
 * IMPORTANT : Ne pas modifier cette configuration sans autorisation !
 */

// Restaurant ID de cette app (configuré pour Mini house)
...
export const RESTAURANT_CONFIG = {
  ...
  appName: process.env.RESTAURANT_NAME || 'Mini house',
  ...
  bundleId: process.env.BUNDLE_ID || 'com.camcook.mini-house',
};
