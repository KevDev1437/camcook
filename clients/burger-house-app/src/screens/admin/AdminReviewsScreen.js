...
const styles = StyleSheet.create({
  ...
  itemPrice: { fontSize: 12, color: 'theme.text.secondary' },
  metaRow: { marginBottom: 8 },
  meta: { color: 'theme.text.secondary', fontSize: 12 },
  ratingRow: { alignItems: 'flex-start', marginBottom: 6 },
  reviewText: { color: 'theme.text.primary', lineHeight: 20 },
  reviewTextMuted: { color: 'theme.text.tertiary', fontStyle: 'italic' },
